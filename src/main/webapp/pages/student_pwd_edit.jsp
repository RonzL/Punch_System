                            ...
                            <div class="tab-pane active" id="settings">
                                <form method="post" action="modify " class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="stuNo" disabled="disabled" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="姓名" class="form-control" id="stuName" disabled="disabled" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" id="passwod_again" value="">
                                        </div>
                                    </div>
