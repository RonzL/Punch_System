                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${pageInfo.list}" var="item" varStatus="i">
                                ...
                                <tr>
                                    ...
                                    <td>${item.noPunchStudents.size()}/${item.allStudents.size()}</td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // 开启分页功能
        load(${pageInfo.currentPage},${pageInfo.pageSize},${pageInfo.totalPage},'${pageContext.request.contextPath}/class/findAll.do')
    });
</script>
</body>
