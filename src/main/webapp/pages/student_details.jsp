                        ...
                        <div class="box-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    ...
                                    <c:if test="${stuInfo.status.equals('Y')}">
                                        <span style="color: green; ">正常</span>
                                    </c:if>
                                    <c:if test="${stuInfo.status.equals('N')}">
                                ...
                                <li class="list-group-item">
                                    <b>打卡天数</b> <a class="pull-right">${stuInfo.days}</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-pane active" id="settings">
                                <form method="post" action="modify " class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="stuNo" value="${stuInfo.studentNo}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" value="${stuInfo.name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="sex" value="${stuInfo.sex}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="class" value="${stuInfo.classNo}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="email" value="${stuInfo.email}"/>
                                        </div>
                                    </div>
