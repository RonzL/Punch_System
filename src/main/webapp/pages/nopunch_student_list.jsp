...
<div class="wrapper">
    ...
    <!-- 导航侧栏 -->
    <jsp:include page="no_punch_students_sidebar.jsp"></jsp:include>
    <!-- 导航侧栏 /-->
                            ...
                            <c:forEach items="${pageInfo.list}" var="item" varStatus="i">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/student/findByStuNo.do?flag=2&stuNo=${item.no}"'>详情</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // 加载分页功能
        load(${pageInfo.currentPage}, ${pageInfo.pageSize}, ${pageInfo.totalPage}, '${pageContext.request.contextPath}/student/findNoPunch.do')
    });
